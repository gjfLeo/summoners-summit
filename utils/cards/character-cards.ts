interface CharacterCardInfo {
  ...
  readonly faction: "Mondstadt" | "Liyue" | "Inazuma" | "Sumeru" | "Fontaine" | "Fatui" | "Eremite" | "Monster" | "None";
}
...
export const ALL_CHARACTER_CARDS_INFO = {
  ...
  迪希雅: defineCharacterCardInfo({ id: 1309, name: "迪希雅", nameEn: "Dehya", element: "Pyro", weapon: "Claymore", faction: "Sumeru" }),
  ...
  流浪者: defineCharacterCardInfo({ id: 1506, name: "流浪者", nameEn: "Wanderer", element: "Anemo", weapon: "Catalyst", faction: "None" }),
